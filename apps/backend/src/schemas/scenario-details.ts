import { object, array, string, number, minLength, maxLength, minValue, optional } from 'valibot';
...
export const messageDetailSchema = object({
  ...
  speaker: optional(string([maxLength(100)])),
...
export const eventDetailSchema = object({
  ...
  eventType: string(),
  order: number([minValue(0)]),
  trigger: optional(string([maxLength(500)])),
