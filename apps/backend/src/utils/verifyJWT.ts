...
export const verifyJWT = async (
  ...
  try {
    ...
    console.log('env.FIREBASE_PROJECT_ID', env.FIREBASE_PROJECT_ID);
    console.log('env.PUBLIC_JWK_CACHE_KEY', env.PUBLIC_JWK_CACHE_KEY);
    console.log('env.PUBLIC_JWK_CACHE_KV', env.PUBLIC_JWK_CACHE_KV);
