...
| ✅ | **`POST /api/users/{uid}/scenario` → `authors/{uid}/scenarios`** | 完了 | 中 | 2025-08-12完了 | Author文脈特化・旧API削除済み |
| 🚧 | **`POST /api/sessions` → `game-masters/{uid}/sessions`** | 進行中 | 中 | 2025-08-12開始 | 新GM文脈エンドポイント |
